...
## Chapter × Theme × Motif × Emotional Arc Grid

*A reference grid mapping each chapter to its themes, motifs, and position in the emotional arc. Use this to identify gaps (chapters serving no theme), disappearances (themes absent for long stretches), and clusters (motifs bunching rather than distributing).*

---

## ARC STAGES KEY

| Stage | Description | Chapters |
|-------|-------------|----------|
| 1. Fear | Olivia wakes afraid that love will fail again | Ch. 1 |
| 2. Recognition | Memories surface, revealing patterns of instability | Ch. 2--6 |
| 3. Investigation | She begins to see where the patterns came from | Ch. 7--12 |
| 4. Darkness | The hardest memories emerge | Ch. 13--16 |
| 5. Understanding | She sees each person as a fragment, not a failure | Ch. 17--18 |
| 6. Integration | She realizes she has been assembling her own model | Ch. 19--23 |
| 7. Choice | She chooses the wedding from earned understanding | Ch. 24--27 |
...
| # | Theme (short label) |
|---|---------------------|
| T1 | Generational patterns / fear of repetition |
| T2 | Fragmented role models |
| T3 | Mental health as lived experience |
| T4 | Self-medication and escape |
| T5 | Queerness and identity |
| T6 | Tradition vs. lived experience |
| T7 | Philosophy as framework and defense |
| T8 | Fashion and identity construction |
| T9 | Misogyny and exploitation of women |
| T10 | The body as site of trauma and healing |
| T11 | Resilience and becoming |
| T12 | Choosing love despite fear |
| T13 | Adults as unreliable narrators of stability |
...
| M5 | Music |
| M6 | Clothing / fashion |
| M7 | Mirrors / reflections |
| M8 | Doors / thresholds |
| M9 | Candles / warmth |
| M10 | Horses |
| M11 | Phones / screens / social media |
| M12 | Empty chairs / absence |
| M13 | Northern California landscape |
| M14 | Colors (pink, blue, purple) |
| M15 | Films |
...
### PART I --- MORNING (Arc: Fear → Recognition)
...
### PART II --- ARRIVAL (Arc: Investigation)
...
### PART III --- BEFORE THE CEREMONY (Arc: Darkness → Understanding)
...
### PART IV --- BECOMING (Arc: Integration)
...
### PART V --- THE RECEPTION (Arc: Choice)
...
## DISTRIBUTION SUMMARY: THEMES

| Theme | Part I | Part II | Part III | Part IV | Part V | Total | Notes |
|-------|--------|---------|----------|---------|--------|-------|-------|
...
| T12 Choosing love | Ch. 1 | --- | --- | Ch. 19, 20 | Ch. 27 | 3 | Bookends the story well |
| T13 Adults as unreliable | Ch. 2, 4, 5 | Ch. 12 | --- | --- | Ch. 24 | 4 | Gap in Parts III and IV |

---

## DISTRIBUTION SUMMARY: MOTIFS
